...
{
    public partial class RequisicionControl : UserControl
    {
        private readonly Conexion _conexion;
        private string usuario = "";
        public RequisicionControl(string usuario)
        {
            InitializeComponent();
        ...
        private void RequisicionControl_Load(object sender, EventArgs e)
        {
        ...
        private void btnGuardarHR_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bitacora.Insertar("Se ha guardado una nueva requisición", usuario);
            }
            catch (Exception ex)
            {
